  ...
  return (
    <div className="flex min-h-screen flex-col bg-codex-bg">
      ...
      <div className="flex min-h-0 flex-1 flex-col items-center justify-center gap-8 px-4">
        ...
        {error ? (
          <p className="rounded-lg border border-rose-500/40 bg-rose-900/20 px-4 py-2
                        text-sm text-rose-300">{error}</p>
        ) : null}
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center gap-3">
            <div className="h-5 w-5 animate-spin rounded-full border-2
                            border-codex-border border-t-codex-accent" />
          ...
          <button
            ...
            className="flex items-center gap-3 rounded-xl border border-codex-border
                       bg-codex-surface px-6 py-3 text-sm font-medium text-slate-200
                       transition-colors hover:border-codex-accent/50 hover:text-white"
          >
